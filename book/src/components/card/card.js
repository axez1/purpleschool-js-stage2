  ...
  render() {
    ...
    this.el.innerHTML = `
      <div class="card__image">
        <img src="https://covers.openlibrary.org/b/olid/${this.cardState.cover_edition_key}-M.jpg" alt="Cover the book" />
      </div>
      <div class="card__info" >
        ...
        <div class="card__footer">
          <button class="button__add ${existInFavorites ? 'button__active' : ''}" >
            ${existInFavorites ? '<img src="/static/favorites.svg" alt="favorite icon" />' : '<img src="/static/favorites-white.svg" alt="favorite icon" />'}
          </button>
        </div>
      </div>
    `;
